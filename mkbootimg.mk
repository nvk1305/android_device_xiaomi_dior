...
A5_DTS_FILES = $(wildcard $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/msm8926-dior*.dts)
...
DTBTAGNAME := "xiaomi,project-id = <"

define append-dior-dtb
